...
class UserRegisterCountry(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'user_register_country'


class UserRegisterUser(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    cname = models.ForeignKey(UserRegisterCountry, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'user_register_user'
